...
Each [release](https://github.com/davidcohenDC/argos-swarm-robotics/releases/latest)
also carries a zip of the sources and the ARGoS source the image is built from.
